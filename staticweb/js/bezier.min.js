...
var d3kit_min_5 = d3kit_min.DivPlate;
var d3kit_min_6 = d3kit_min.helper;
...
class BezierTable extends d3kit_min_1 {
  ...
  static getCustomEventNames() {
    ...
    // Add custom variables
		...
		this.addPlate('main_table', new d3kit_min_5());
  ...
  visualize() {
    ...
    const data = this.data();
		...
		// const rows = this.table.selectAll('tr.datapoint')
		...
		// rows.merge(idEnter).text(d => d.id);
		// rows.merge(xEnter).text(d => d.x);
		// rows.merge(yEnter).text(d => d.y);
