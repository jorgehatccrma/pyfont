...
class Bezier extends d3kit_min_4 {
	// Define default options for this chart
  static getDefaultOptions() {
    return d3kit_min_5.deepExtend(
  ...
  visualize() {
    ...
    selection.exit().remove();
		...
		function dragged(d) {
			...
			circle.raise()
				.attr("cx", d.x = thisInstance.xScale.invert(event.x))
				.attr("cy", d.y = thisInstance.yScale.invert(event.y));
